...
def get_favorite_video_links(json_file_path, max_videos=100):
    ...
    # Navigate through the JSON structure to find the "Favorite Videos" key
...
if __name__ == "__main__":
    json_file_path = 'path_to_your_json_file.json'  # Update this with the path to your JSON file
